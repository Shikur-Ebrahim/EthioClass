...
class _AllCategoriesScreenState extends State<AllCategoriesScreen> {
  ...
  static const List<Color> _headerColors = [
    Color(0xFF1E3A8A), Color(0xFF166534), Color(0xFF831843), Color(0xFF065F46),
    Color(0xFF1D4ED8), Color(0xFF7C3AED), Color(0xFFB45309), Color(0xFF0F172A),
    Color(0xFF9D174D), Color(0xFF0369A1),
  ];

  static const List<Color> _iconColors = [
    Color(0xFF93C5FD), Color(0xFF86EFAC), Color(0xFFF9A8D4), Color(0xFF6EE7B7),
    Color(0xFFA5B4FC), Color(0xFFD8B4FE), Color(0xFFFCD34D), Color(0xFF94A3B8),
    Color(0xFFFBCFE8), Color(0xFF7DD3FC),
  ];

  static const List<IconData> _categoryIcons = [
    Icons.school_rounded, Icons.science_rounded, Icons.calculate_rounded,
    Icons.biotech_rounded, Icons.history_edu_rounded, Icons.language_rounded,
    Icons.computer_rounded, Icons.music_note_rounded, Icons.brush_rounded,
  ...
  Future<void> _loadCategories() async {
    try {
      ...
      if (mounted) {
        setState(() { _allCategories = cats; _filtered = cats; _isLoading = false; });
      }
    } catch (e) {
  ...
  void _onSearch() {
    ...
    setState(() {
      _searchQuery = q;
      _filtered = q.isEmpty ? _allCategories
                  ...
                  child: Row(children: [
                    ...
                    if (!_isLoading)
                      Container(
                        ...
                        child: Text('${_allCategories.length} total',
            ...
            child: _isLoading
                ...
                : _filtered.isEmpty
                    ? Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                        ...
                        const SizedBox(height: 16),
                        Text(
                          _searchQuery.isNotEmpty ? 'No results for "$_searchQuery"' : 'No categories yet',
...
class _CategoryGridCard extends StatelessWidget {
  ...
  const _CategoryGridCard({
    ...
    required this.headerColor, required this.iconColor,
  ...
  Widget _buildGradientBanner() {
    return Container(
      ...
      child: Center(child: Icon(icon, color: iconColor.withOpacity(0.85), size: 44)),
    );
  }
                ...
                Align(
                  ...
                  child: Container(
                    ...
                    child: Row(mainAxisSize: MainAxisSize.min, children: [
                      Text('Explore', style: TextStyle(fontSize: 10, fontWeight: FontWeight.w700, color: headerColor)),
                      const SizedBox(width: 2),
                      Icon(Icons.arrow_forward_rounded, size: 10, color: headerColor),
                    ]),
                  ),
                ),
              ]),
